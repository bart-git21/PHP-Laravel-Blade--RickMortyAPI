                ...
                <a class="text-decoration-none"
                    ...
                    <div class="card text-center" style="width: 10rem;">
                        ...
                        <div class="position-absolute end-0">
                            @php
                                $favorite = (DB::table('favorite_characters')->where('user_id', $user_id)->where('character_id', $single->character_id)->exists()) ? 'favorite' : ''
                            @endphp
                            <svg class="{{ $favorite }}" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none">
                                <path fill="white"
